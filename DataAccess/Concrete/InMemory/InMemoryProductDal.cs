...
namespace DataAccess.Concrete.InMemory
{
    ...
    {
        List<Product> _products; //Global değişken olduğu için _ ile baslamalı.

        public InMemoryProductDal()
        {
            //Oracle, SQL Server, Postgres, MongoDb geliyomuş gibi simüle edilecek.
        ...
        {
            //LINQ - Language Integrated Query - Dile Gömülü Sıralama
